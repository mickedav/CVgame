Last = function(screenWidth, screenHight, framework){
	...
	this.bgImg = new Image()
	this.bgImg.src = "img/lastbg.jpg";

	this.bgImg2 = new Image()
	this.bgImg2.src = "img/clouds.png";
	...
	this.inverter = 1;
	this.name = "Level X";
	this.signInfo =['Welcome to the Level X!', 'This is the "last" level.', 'What will happend on ', 'this level has not yet', 'been decided.', 'My next job will decide', 'the design of this level.'];
